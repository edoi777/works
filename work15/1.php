...
<main>
  <div>
        ...
        <div class="produkciya">
            <div class="pr_1">
               <img src="img/page_1/p_1.jpg" alt="">
                <p class="podpis">
                    Прожекторные мачты
                </p>
            </div>
            <div class="pr_2">
                <img src="img/page_1/p_2.jpg" alt="">
                <p class="podpis">
                   
                </p>
            </div>
            <div class="pr_3">
                <img src="img/page_1/p_3.jpg" alt="">
                <p class="podpis">
                   Лестницы стремянки
площадки и ограждения
            ...
            <div class="pr_4">
                <img src="img/page_1/p_4.jpg" alt="">
                <p class="podpis">
...
стальные 
            ...
            <div class="pr_5">
                <img src="img/page_1/p_5.jpg" alt="">
                <p class="podpis">
                  Прожекторные мачты
                </p>
            </div>
            <div class="pr_6">
                <img src="img/page_1/p_6.jpg" alt="">
                <p class="podpis">
                  Прожекторные мачты
                </p>
            </div>
            <div class="pr_7">
                <img src="img/page_1/p_7.jpg" alt="">
                <p class="podpis">
                 Ростверки
                </p>
            </div>
            <div class="pr_8">
                <img src="img/page_1/p_8.jpg" alt="">
                <p class="podpis">
                 Металлические поры ВЛ
и ЛЭП
                </p>
            </div>
            <div class="pr_9">
                <img src="img/page_1/p_9.jpg" alt="">
                <p class="podpis">
                 Нестандартные изделия
                </p>
            </div>
            <div class="pr_10">
                <img src="img/page_1/p_10.jpg" alt="">
                <p class="podpis">
                 Фундаментные болты
                </p>
            </div>
            <div class="pr_11">
                <img src="img/page_1/p_11.jpg" alt="">
                <p class="podpis">
                Сваи металлические
                </p>
            </div>
            <div class="pr_12">
                <img src="img/page_1/p_12.jpg" alt="">
                <p class="podpis">
                Сальники набивные
                </p>
            </div>
            <div class="pr_13">
                <img src="img/page_1/p_13.jpg" alt="">
                <p class="podpis">
                Емкость подземная
                </p>
            </div>
            <div class="pr_14">
                <img src="img/page_1/p_14.jpg" alt="">
                <p class="podpis">
               Закладные детали
                </p>
            </div>
            <div class="pr_15">
                <img src="img/page_1/p_15.jpg" alt="">
                <p class="podpis">
               Заборы столбики
                </p>
            </div>
            <div class="pr_16">
                <img src="img/page_1/p_16.jpg" alt="">
                <p class="podpis">
               Баки септики
                </p>
            </div>
        ...
        <div class="content o_nas">
            <h1>О нас</h1>
            <b><span>ООО «ТМСН»</span> - Металлоконструкции, Строительные металлоконструкции, Конструкции стальные строительные, Резервуары 
    вертикальные, горизонтальные, стальные, Емкости подземные</b>

    <p><span>ООО «ТМСН»</span> специализируется на производстве как стандартного, так и нестандартного емкостного и резервуарного оборудования по 
    типовым проектам и чертежам заказчика для нефтеперерабатывающих заводов, металлургической, химической и нефтехимической, для 
    строительства нефтепроводов, атомных и тепловых станций, а также при строительстве и реконструкции нефтебаз, для различных отраслей, 
    где используют резервуарное и емкостное оборудование.</p>
      ...
      <div class="content">
          ...
          <div class="ul_list">
              <ul>
                    ...
                    <li>Выпуск конструкторской документации</li>
                    <li>Производство работ</li>
                    <li>Покраска</li>
                    <li>Доставка изделий заказчику</li>
              </ul>
              <ul>
                    <li>Создание документации возводимых конструкций</li>
                    <li>Производство конструкций из металла по разработкам заказчика</li>
                    <li>Изготовление опор трубопроводов</li>
                    <li>Производство матч для последующей установки на них прожекторов</li>
                    <li>Изготовление анкерных болтов и траверсов линий электропередач</li>
                    <li>Производство емкостного оборудования</li>
              </ul>
          </div>
          <p><b>Возможности компании позволяют производить различные металлоконструкции любого назначения, с учётом пожеланий заказчика. </b>
По согласованию с заказчиком возможен выпуск металлоконструкций различной сложности, формы и размеров, в том числе монтажные, 
строительные, технологические металлические конструкции, а также детали и узлы, быстровозводимые металлоконструкции и сооружения.</p>
      </div>
  </div>
  <div class="block_3">
      <div class="content">
          ...
          <div class="news">
              <div class="item">
                  <img src="img/news_item_1.jpg" alt="">
                  <div class="item_description">
                      <div class="date">05 Ноября 2016 г</div>
                        <p class="title">В Кропоткине будет построен 
                        завод металлоконструкций</p>
                       <p class="text_item"> В Краснодарском крае в городе 
                        Кропоткин будет возведен завод по 
                        изготовлению строительных 
                        металлоконструкций.</p>
                  </div>
              </div>
              <div class="item">
                  <img src="img/news_item_2.jpg" alt="">
                  <div class="item_description">
                      <div class="date">05 Ноября 2016 г</div>
                        <p class="title">Время рекордов на строительстве 
                        Крымского моста</p>
                       <p class="text_item"> 
                        В сентябре 2016 года было 
                        погружено 339 трубосвай. Это 
                        рекордный результат с начала 
                        реализации проекта.</p>
                  </div>
              </div>
          </div>
          <a href="#" class="button_type_2">Больше новостей ></a>
      </div>
  </div>
</main>
<?php include 'include/footer.php' ?>
    ...
    <link rel="stylesheet" href="css/pages/page_1.css">
